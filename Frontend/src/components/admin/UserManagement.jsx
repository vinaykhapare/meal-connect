...
export default function UserManagement() {
  ...
  const handleFilter      = () => fetchUsers(pincode);
  const handleClearFilter = () => { setPincode(""); fetchUsers(); };

  const openEdit = (user) => {
    setEditUser(user);
    setEditForm({ name: user.name, email: user.email, phone: user.phone, location: user.location, pincode: user.pincode });
  };
    ...
    >
      ...
      <div className="flex items-center gap-2.5 mb-5">
        <div className="w-9 h-9 rounded-xl bg-red-50 border border-red-100 flex items-center justify-center flex-shrink-0">
          <PeopleOutlinedIcon sx={{ color: "#dc2626", fontSize: 20 }} />
        </div>
        <div>
          ...
          <Typography variant="caption" color="text.secondary">
            Search, edit and remove registered donors
          </Typography>
        </div>
      </div>
            ...
            InputProps={{
              startAdornment: (
                <InputAdornment position="start">
                  <FilterAltOutlinedIcon sx={{ fontSize: 17, color: "#dc2626" }} />
                </InputAdornment>
              ),
            }}
            sx={inputSx}
            ...
            <Table size="small" aria-label="User management table">
              <TableHead>
                <TableRow sx={{ background: "#f8fafc" }}>
                  {["Name", "Email", "Phone", "Location", "Pincode", "Actions"].map((h) => (
                    <TableCell key={h} sx={{
                  ...
                  <TableRow>
                    <TableCell colSpan={6} sx={{ textAlign: "center", py: 6 }}>
                      <div className="flex flex-col items-center gap-2">
                        <PeopleOutlinedIcon sx={{ color: "#cbd5e1", fontSize: 36 }} />
                    ...
                    <TableRow key={u._id} sx={{
                      ...
                      <TableCell sx={{ textAlign: "center" }}>
                        <div className="flex items-center justify-center gap-1.5">
                          <Tooltip title="Edit user" arrow TransitionComponent={Fade}>
                            <IconButton
                              size="small"
                              onClick={() => openEdit(u)}
                          ...
                          <Tooltip title="Delete user" arrow TransitionComponent={Fade}>
                            <IconButton
                              size="small"
        ...
        <DialogContent sx={{ px: 4, py: 4 }}>
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <DialogTitle id="edit-user-title" sx={{ p: 0, fontSize: "1rem", fontWeight: 700, color: "#1a1a2e" }}>
                  Edit User
                </DialogTitle>
                <Typography variant="caption" color="text.secondary">
                  Update donor account details
                </Typography>
              </div>
            </div>
            <IconButton size="small" onClick={() => setEditUser(null)} aria-label="Close edit dialog"
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-2 justify-end pt-1">
              <Button variant="outlined" size="small" onClick={() => setEditUser(null)}
      ...
      >
        ...
        <DialogContent sx={{ px: 4, py: 4 }}>
          ...
          >
            ...
            <div>
              <Typography id="delete-user-title" variant="h6" fontWeight={700} sx={{ color: "#1a1a2e" }}>
                Delete User?
              </Typography>
              <Typography id="delete-user-description" variant="body2" color="text.secondary" sx={{ mt: 0.5, lineHeight: 1.7 }}>
                This action <strong>cannot be undone</strong>. All data associated with this user will be permanently removed.
              </Typography>
            </div>
